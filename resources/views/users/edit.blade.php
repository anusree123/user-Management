            ...
            <div class="offset-md-3 col-md-6">
                <form method="POST" action={{url('users/' . $user->id)}} enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="mobile" name="mobile" class="form-control @error('mobile') is-invalid @enderror" id="mobile" value='{{$user->mobile}}'>
                        @error('mobile')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="address" name="address" class="form-control @error('address') is-invalid @enderror" id="address" value='{{$user->address}}'>
                        @error('address')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
